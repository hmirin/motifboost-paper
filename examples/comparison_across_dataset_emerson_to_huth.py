...
if __name__=="__main__":
    ...
    for classifier_prefix, classifier in tqdm(classifier_dict.items(), desc="classifiers"):
        main(
            mlflow_experiment_id="cross_learning_from_emerson_hip_to_huth" + os.uname().nodename,
            save_dir=save_dir,
            fig_save_dir="./data/",
            experiment_id="emerson_hip_to_huth",
            get_split=emerson_hip_to_huth_split,
            filter_by_sample_id=None,
            filter_by_repertoire=None,
            get_class=lambda x: x.info["CMV"],
            classifier=classifier,
            prefix="_".join(["emerson_hip_to_huth", classifier_prefix]),
